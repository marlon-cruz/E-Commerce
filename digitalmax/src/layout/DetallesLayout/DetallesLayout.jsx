...
function DetallesLayout() {
    ...
    return (
        <> 
        {Loading(loading)}
        <ProductoDetallado imagen={product.imagenUrl} imagen2 = {product.imagenUrl1} nombre = {product.nombre} categoria = {product.categoria} marca={product.marca} modelo = {product.modelo} precioDes = {product.precio} precio = {product.precio} descuento ={product.descuento} stock={product.stock} descripcion = {product.descripcion} especificaciones = {product.especificaciones} />
        </>
    );
}
