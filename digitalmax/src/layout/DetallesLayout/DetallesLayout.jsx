...
function DetallesLayout() {
    ...
    return (
        <> 
        {Loading(loading)}
        <ProductoDetallado StardCalificacion = {product.valoracion} productID = {product._id} imagen={product.imagenUrl} imagen2 = {product.imagenUrl1} imagen3 = {product.imagenUrl2} nombre = {product.nombre} categoria = {product.categoria} marca={product.marca} modelo = {product.modelo} precioDes = {product.precio} precio = {product.precio} descuento ={product.descuento} stock={product.stock} descripcion = {product.descripcion} especificaciones = {product.especificaciones} />
        </>
    );
}
